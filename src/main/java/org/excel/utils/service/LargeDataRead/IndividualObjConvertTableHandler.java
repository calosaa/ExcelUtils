...
public class IndividualObjConvertTableHandler<D> extends DefaultHandler {
    private ArrayList<String> sharedStr;
    private List<D> table;
    ...
    private ConvertHandler<D> convertHandler;
    ...
    private String dateFormat = "m/d/yy,yyyy\\-mm\\-dd;@,yyyy/m/d;@,yyyy/m/d\\ h:mm;@,mm/dd/yy;@,m/d;@,"
            + "yy/m/d;@,m/d/yy;@,[$-409]yyyy/m/d\\ h:mm\\ AM/PM;@,[$-F800]dddd\\,\\ mmmm\\ dd\\,\\ yyyy";
    public IndividualObjConvertTableHandler(ArrayList<String> sharedStr,StylesTable stylesTable,ConvertHandler<D> handler){
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("v")){
            ...
            D row = convertHandler.convert(currRow, ++index);
    ...
    public List<D> getTable() {
        return table;
    }

    public interface ConvertHandler<D>{
        D convert(ArrayList<String> str,int index);
    }
}
